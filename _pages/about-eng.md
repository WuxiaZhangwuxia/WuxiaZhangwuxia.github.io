...
Journal Papers
	...
	•	Zhang W, Lu X. The spectral-spatial joint learning for change detection in multispectral imagery[J]. Remote Sensing, 2019, 11(3): 240.
...
Patents
	•	Zhang Wuxia, Lei Yaxin, Li Zhi, Wan Li, Chen Lei, Zhang Boyi. A multi-spectral image change detection method and system. Chinese Patent: ZL 2024 1 1813083.6. Date: 2025-02-25.

	•	Zhang Wuxia, Shu Xinlong, Li Zhi, Lei Yaxin, Chen Lei, Wan Li. A semi-supervised remote sensing image change detection method and system. Chinese Patent: ZL 2024 1 1942130.7. Date: 2025-02-28.

	•	Zhang Wuxia, Liu Shuo, Zhang Yuhang, Yang Ling. A method for extracting cloud particle data regions. Chinese Patent: ZL 2022 10374304.9. Date: 2023-04-07.

	•	Zhang Wuxia, Shao Xiaoxiao, Li Zhi, Wan Li, Zhang Boyi. A spacecraft component recognition method and system. Chinese Patent: ZL2024 1 1595060.2. Date: 2025-02-28.

	•	Zhang Wuxia, Guo Huibo, Zhang Yuhang, Su Liangxu. A hyperspectral image change detection method based on spectral Transformer network. Chinese Patent: 202310053970.7. Date: 2023-02-03.

	•	Zhang Wuxia, Zhang Yuhang, Gao Shiwen, Gao Yuan, Quan Wenrui, Qiang Qiqi. A hyperspectral image multi-class change detection method and system based on spectral-guided Transformer network model. Chinese Patent: 202311292197.6. Date: 2023-10-08.

	•	Zhang Wuxia, Zhang Qinyu, Yang Junyi, Xu Yingjie, Wang Simin, Lu Yu. A multispectral change detection method and system based on cascaded cross-attention mechanism and differential feature learning. Chinese Patent: 202310441674.4. Date: 2023-04-23.

	•	Lu Xiaoqiang, Li Xuelong, Zhang Wuxia. A hyperspectral target detection method based on combination of sparse representation and discriminant analysis. Chinese Patent: 201710373032X (invention patent), authorized.

	•	Lu Xiaoqiang, Zhang Wuxia, Li Xuelong. A hyperspectral anomaly target detection method based on similarity-constrained convex nonnegative matrix factorization. Chinese Patent: 2018116159868 (invention patent), authorized.

	•	Lu Xiaoqiang, Zhang Wuxia, Li Xuelong. A spatial-spectral joint feature learning network and multispectral change detection method. Chinese Patent: 2018116159779 (invention patent), authorized.

	•	Liu Shuo, Zhang Wuxia, et al. A remote sensing image cloud detection method based on region growing. Chinese Patent: 2019100522930 (invention patent), published.

	•	Liu Shuo, Zhang Wuxia, et al. A SAR image target detection optimization method based on multiple SVD saliency fusion. Chinese Patent: 2019100525074, published.

	•	Lu Xiaoqiang, Zhang Wuxia, et al. A hyperspectral anomaly detection algorithm based on manifold-constrained auto-encoding network. Chinese Patent: ZL 201910412013.2, authorized.
